...
Blockly.Msg.CAT_OOROBOT = "OoRoBoT";
Blockly.Msg.CAT_OOROBOT_KEYPAD = "- Clavier";
Blockly.Msg.CAT_OOROBOT_I2C = "- Ecran LCD i2c";
Blockly.Msg.CAT_OOROBOT_STEPPER = "- Moteurs pas-à-pas";
Blockly.Msg.CAT_OOROBOT_BT = "- Bluetooth";
Blockly.Msg.CAT_OOROBOT_SERVO = "- Servomoteur";
Blockly.Msg.CAT_OOROBOT_SERVO_DEFAULT_NAME = "crayon";
Blockly.Msg.OOROBOT_KEYPAD_INIT = "initialiser le clavier sur la  broche analogique";
Blockly.Msg.OOROBOT_KEYPAD_PRESSED = "un bouton du clavier est appuyé ?";
Blockly.Msg.OOROBOT_KEYPAD_PRESSED_TOOLTIP = "Index du bouton pressé, 0 si aucun";
Blockly.Msg.OOROBOT_DEFAULT_RIGHT_STEPPER_MOTOR_NAME = "droit";
Blockly.Msg.OOROBOT_DEFAULT_LEFT_STEPPER_MOTOR_NAME = "gauche";
Blockly.Msg.OOROBOT_STEPPER_SETUP = "initialiser le";
Blockly.Msg.OOROBOT_STEPPER_ENABLE = "activer le moteur pas-à-pas";
Blockly.Msg.OOROBOT_STEPPER_DISABLE = "désactiver le moteur pas-à-pas";
Blockly.Msg.OOROBOT_STEPPER_RUN_SPEED_TO_POSITION = "démarrer le moteur PàP";
Blockly.Msg.OOROBOT_STEPPER_SET_SPEED = "fixer la vitesse du moteur PàP";
Blockly.Msg.OOROBOT_STEPPER_OF = "de";
Blockly.Msg.OOROBOT_STEPPER_TO = "à";
Blockly.Msg.OOROBOT_STEPPER_MOVE_TO = "fixer la distance à parcourir au moteur PàP";
Blockly.Msg.OOROBOT_STEPPER_DISTANCE_TO_GO = "distance qu'il reste à parcourir sur le moteur PàP";
